...
**做空条件**
1. 价格在15m MA60附近或下穿, 1h/4h MA60下方
2. 15m RSI > 50, 1h/4h RSI在30-70区间走弱
3. 窄幅震荡后向下突破
4. 资金费率为正（仅在无仓位入场时硬性要求）

**做多条件**（熊市博反弹，需谨慎）
1. RSI(15m/1h/4h)全部<30 进入超卖区
2. 资金费率为负（仅在无仓位入场时硬性要求）
3. 出现明显支撑位反弹迹象
4. 仅博价格反弹3%左右，严格止盈

**极端行情**：
- 底部（RSI(15m/1h/4h)全部<30）→ 禁止追空，等反弹
- 顶部（RSI(15m/1h/4h)全部>70）→ 优质做空机会
