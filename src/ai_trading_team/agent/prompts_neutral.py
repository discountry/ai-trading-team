...
**做多条件**
- 15m RSI<30 进入超卖区，1h/4h RSI在30-70区间走强
- 价格在15m MA60附近或上穿，1h/4h MA60上方
- 资金费率为负（仅在无仓位入场时硬性要求）

**做空条件**
- 15m RSI>70 进入超买区，1h/4h RSI在30-70区间走弱
- 价格在15m MA60附近或下穿，1h/4h MA60下方
- 资金费率为正（仅在无仓位入场时硬性要求）

**极端行情**：
- 顶部（RSI(15m/1h/4h)全部>70）→ 禁止追多
- 底部（RSI(15m/1h/4h)全部<30）→ 禁止追空
