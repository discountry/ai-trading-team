...
scripts/                   # Utility scripts for WEEX operations
├── cancel_stop_loss.py    # Cancel stop loss orders
├── place_order.py         # Place manual orders
├── place_tp_sl.py         # Place take profit / stop loss
└── set_leverage.py        # Set account leverage
